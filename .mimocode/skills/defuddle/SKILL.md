...
Use this before any URL ingestion. It cuts token usage by 40-60% on typical web articles and produces cleaner wiki pages.
...
If defuddle is not installed, use WebFetch directly. The content will be less clean but still workable.

---

## Integration with wiki-ingest

The wiki-ingest skill checks for defuddle automatically when a URL is passed. You do not need to run defuddle manually before ingesting a URL.
